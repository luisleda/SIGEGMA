                        ...
                        <div class="mx-auto rounded-3 float-start">
                                ...
                                <div class="col " >
                                    <div class=" p-3 text-primary  rounded-3 font-weight-bold">
                                            ...
                                            <p><i class="bi bi-emoji-heart-eyes"></i>Área de cadastro inicial, inscrição nos cursos e demais<br/> formações disponíveis, dentre outros procedimentos online<br/> Capacitando o servidor público.</p>
